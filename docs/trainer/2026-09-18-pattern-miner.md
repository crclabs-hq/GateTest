...
_Generated 2026-09-18T08:01:02.917Z_

Inputs: 219 session-fix(es), 0 fix-attempt(s), 0 MCP event(s).

## Recommendations

- **investigate-module** — `website`: 13 session-fixes recorded — high-touch module, candidate for refactor or rule split
