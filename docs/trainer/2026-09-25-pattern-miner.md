...
_Generated 2026-09-25T08:35:24.405Z_

Inputs: 233 session-fix(es), 0 fix-attempt(s), 0 MCP event(s).

## Recommendations

- **investigate-module** — `website`: 21 session-fixes recorded — high-touch module, candidate for refactor or rule split
- **investigate-module** — `deploy`: 13 session-fixes recorded — high-touch module, candidate for refactor or rule split
