...
- **Builders still running:** move 4 (time-to-verdict, wt-eta), move 12 (root cause on red runs, wt-rootcause), move 2 (precision per rule, wt-precision). Move 20 delivered (#763).
