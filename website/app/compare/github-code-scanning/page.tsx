          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {[
              ...
              },
              {
                ...
                body: "CodeQL works from a database of query patterns. GateTest's AI review applies semantic reasoning to your code — understanding what the code intends, identifying logic bugs, spotting off-by-one errors in financial calculations, flagging race conditions in auth flows. Pattern databases can't catch logic errors. AI can.",
              },
              {
