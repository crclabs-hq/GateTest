...
const TIER_DESCRIPTIONS = {
  ...
  full:     { label: 'Full',      priceUsd: 99,  description: 'Every applicable module of the 121-module engine + AI code review + every clustered issue + health score (scan-only, no auto-fix)' },
  scan_fix: { label: 'Scan + Fix', priceUsd: 199, description: 'Every applicable module of the 121-module engine + AI auto-fix PR + regression tests + pair-review' },
