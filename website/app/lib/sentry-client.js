/**
 * Re-export shim — the canonical Sentry client lives at
 * src/core/sentry-client.js so the MCP server (CLI-side) and the website
 ...
 */
module.exports = require('../../../src/core/sentry-client.js');
