...
export default function AdminPanel({ adminLogin }: AdminPanelProps) {
  ...
  const [activeTab, setActiveTab] = useState<"scan" | "server" | "nuclear" | "watchdog" | "scans" | "customers" | "keys" | "platforms">("scan");
  ...
  }, [activeTab, loadKeys, loadWatches, loadPlatforms]);
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-6">
        ...
        <div className="flex gap-1 mb-6 border-b border-gray-200 overflow-x-auto">
          {(["scan", "server", "nuclear", "watchdog", "scans", "customers", "keys", "platforms"] as const).map((tab) => (
            <button
              key={tab}
