...
- [ ] Lighthouse >= 95`,
  ...
  {
    step: "02",
    title: "GateTest runs 102 modules",
    description:
...
...modules continue ...`,
  },
  {
    ...
    description:
      "Zero tolerance. One failure in any of the 102 modules blocks the entire pipeline. No overrides. No \"ship it anyway.\" The gate produces a timestamped report with full evidence.",
    code: `GATE: PASSED
