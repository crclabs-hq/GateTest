...
const ROWS: Row[] = [
  ...
  { feature: "AI code review (reads your code, not patterns)", quick: false,   full: true,   scanFix: true,   nuclear: true   },
  ...
  { feature: "Pair-review (a second AI reviewer critiques)",  quick: false,   full: false,  scanFix: true,   nuclear: true   },
  { feature: "Architecture annotations",                    quick: false,   full: false,  scanFix: true,   nuclear: true   },
  { feature: "Per-finding AI diagnosis",                    quick: false,   full: false,  scanFix: false,  nuclear: true   },
