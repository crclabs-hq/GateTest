...
export const REGULATIONS: Regulation[] = [
  {
    ...
    catchableTechnicalFindings: [
      "Personal data (req.body, headers, cookies, session, password / token fields) logged in plaintext via console.log / logger.info — violates Art. 5(1)(f) integrity-and-confidentiality.",
      "Hardcoded database credentials or API keys in committed source — Art. 32 security-of-processing failure.",
      "Database migrations that drop or rename columns and tables — surfaced so you can confirm the data had a retention basis before it disappears — Art. 5(1)(e) storage limitation.",
      ...
      "Unpinned third-party GitHub Actions and continue-on-error on the CI security gate for services that process personal data — Art. 32 technical-and-organisational measures.",
  ...
  },
  {
    ...
    catchableTechnicalFindings: [
      ...
      "Database migrations that drop / rename columns and tables — surfaced so the deletion-request path can be confirmed before consumer data disappears — § 1798.105 right-to-delete.",
      "Client-bundled NEXT_PUBLIC_* / VITE_* / REACT_APP_* keys and undeclared env reads that ship consumer-data credentials to the browser — § 1798.100(c) reasonable security.",
  ...
  },
  {
    ...
    catchableTechnicalFindings: [
      ...
      "Fields named cardNumber / creditCard / cvv / cvc passed to console or logger calls — Req. 3.3 prohibits storing CVV after authorisation; logs count.",
