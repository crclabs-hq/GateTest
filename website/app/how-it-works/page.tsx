...
const LIMITS = [
  ...
  "The VS Code extension is brand new (GateTestHQ.gatetest 1.1.0, published 16 September 2026). It runs the same engine in-process and shows findings in the Problems panel, but it has no install base or reviews yet, and Cursor and Windsurf installs are untested. The proven loop is still push → CI → PR comment.",
];
