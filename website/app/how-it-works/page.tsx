...
const LIMITS = [
  ...
  "The editor extension is brand new (on the Visual Studio Marketplace and on Open VSX — the registry Cursor, Windsurf and VSCodium read — since 16 September 2026). It runs the same engine in-process and shows findings in the Problems panel, but it has no install base or reviews yet. The proven loop is still push → CI → PR comment.",
];
