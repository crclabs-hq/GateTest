...
GateTest v1.50.0 — **111 modules**, **Claude Sonnet 4.6**. Backend tier
config (`/api/checkout/route.ts` `TIERS`) = five tiers ($29 Quick /
$99 Full / $199 Scan+Fix / $399 Nuclear + $49/mo Continuous). **NOTE:
the public Pricing UI (`Pricing.tsx`) has DRIFTED out of sync with this
backend — see Known Issue #35. Pricing reconciliation is Boss Rule #3 /
#8 and awaits Craig.** Date stamp last fully reconciled: 2026-06-23.
...
- **DRIFT FLAGGED (not changed — Boss Rule):** `Pricing.tsx` shows Quick $29 / Full Deep Scan $99 / **Continuous Guard Shield $299/mo**, and NO $199 / $399 cards. This contradicts the backend ($49/mo Continuous; $199 + $399 tiers exist) AND commit 14e6e36's stated intent (remove $29/$99, keep 2 paid tiers). Public copy also says "90+ modules" vs the real 111. Recorded as Known Issue #35 for Craig's decision — pricing + public marketing copy are Boss Rule #3 / #8.
